...
namespace ThinkGeo.MapSuite.DebugSamples
{
    public class DisplayFeatureLayerAtCertainScale : UserControl
    {
        ...
        private void btnLow_Click(object sender, EventArgs e)
        {
            ...
            winformsMap1.CurrentExtent = ExtentHelper.ZoomToScale(zoomLevelSet.ZoomLevel06.Scale, winformsMap1.CurrentExtent, GeographyUnit.DecimalDegree, winformsMap1.Width, winformsMap1.Height);
        ...
        {
            ZoomLevelSet zoomLevelSet = new ZoomLevelSet();
            winformsMap1.CurrentExtent = ExtentHelper.ZoomToScale(zoomLevelSet.ZoomLevel05.Scale, winformsMap1.CurrentExtent, GeographyUnit.DecimalDegree, winformsMap1.Width, winformsMap1.Height);
